...
public class findCatagoryDriver {
    public static void main(String args[]) throws Exception
    {
        ...
        j.setJarByClass(findCatagoryDriver.class);

        j.setMapperClass(findCatagoryMap.class);

        j.setReducerClass(findCatagoryReduce.class);
